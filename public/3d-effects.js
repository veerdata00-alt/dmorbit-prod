/**
 * DMOrbit 3D Effects Engine
 * Includes: Three.js Background & Mouse Tilt Logic
 */
...
function initTiltEffect() {
      const cards = document.querySelectorAll('.feature-card, .auth-card, .glass-panel, .stat-card');
...
document.addEventListener('DOMContentLoaded', () => {
      ...
      initTiltEffect();
                              ...
                              // Add floating class to some icons
